...
sample_block = 2  # draw samples from several numbers of slum blocks
# slum_patches = 1000  # number of training patches drawn from sample slum blocks 
non_slum_patches = 1000
...
dilate1_1 = AtrousConvolution2D(32, (3, 3), padding='same', activation='relu', atrous_rate=(2,2))(relu1_2)
dilate1_2 = AtrousConvolution2D(32, (3, 3), padding='same', activation='relu', atrous_rate=(4,4))(relu1_2)
dilate1_3 = AtrousConvolution2D(32, (3, 3), padding='same', activation='relu', atrous_rate=(7,7))(relu1_2)
concat1 = concatenate([relu1_2, dilate1_1, dilate1_2, dilate1_3], axis=3)
...
dilate2_1 = AtrousConvolution2D(32, (3, 3), padding='same', activation='relu', atrous_rate=(2,2))(relu2_2)
dilate2_2 = AtrousConvolution2D(32, (3, 3), padding='same', activation='relu', atrous_rate=(3,3))(relu2_2)
dilate2_3 = AtrousConvolution2D(32, (3, 3), padding='same', activation='relu', atrous_rate=(5,5))(relu2_2)
concat2 = concatenate([relu2_2, dilate2_1, dilate2_2, dilate2_3], axis=3)
...
dilate3_1 = AtrousConvolution2D(32, (3, 3), padding='same', activation='relu', atrous_rate=(2,2))(relu3_2)
dilate3_2 = AtrousConvolution2D(32, (3, 3), padding='same', activation='relu', atrous_rate=(3,3))(relu3_2)
concat3 = concatenate([relu3_2, dilate3_1, dilate3_2], axis=3)
...
dilate4_1 = AtrousConvolution2D(32, (3, 3), padding='same', activation='relu', atrous_rate=(2,2))(relu4_2)
concat4 = concatenate([relu4_2, dilate4_1], axis=3)
...
up6 = concatenate([Conv2DTranspose(256, (2, 2), strides=(2, 2), padding='same')(relu5_2), concat4], axis=3)
...
up7 = concatenate([Conv2DTranspose(128, (2, 2), strides=(2, 2), padding='same')(relu6_2), concat3], axis=3)
...
up8 = concatenate([Conv2DTranspose(64, (2, 2), strides=(2, 2), padding='same')(relu7_2), concat2], axis=3)
...
up9 = concatenate([Conv2DTranspose(32, (2, 2), strides=(2, 2), padding='same')(relu8_2), concat1], axis=3)
...
if not data_augmentation:
    ...
    csv_logger = CSVLogger('slumDetectLog1.csv')
    ...
    model.save_weights('slumDetecWeights1.h5')
    ...
    csv_logger = CSVLogger('slumDetectLog2.csv')
